...
export function StickyNavbar() {
  ...
  return (
    <Navbar className="sticky top-0 z-10 h-max max-w-full rounded-none px-4 py-2 lg:px-8 lg:py-2 bg-whit-gray-100 bg-slate-200 ">
      <div className="flex items-center justify-evenly text-blue-gray-900">
        ...
        >
          <Link to="/"><img src="/llogo.svg" alt="" /></Link>
        </Typography>
